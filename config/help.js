...
export const helpList = [
    ...
    },
    {
        group: "语音娱乐",
        list: [
            { icon: 87, title: "#三角洲语音", desc: "随机播放角色语音" },
            { icon: 87, title: "#三角洲角色语音 [角色名]", desc: "播放指定角色语音" },
            { icon: 87, title: "#三角洲角色语音 [角色名] [局内/局外]", desc: "播放指定场景语音" },
            { icon: 87, title: "#三角洲角色语音 [角色名] [局内/局外] [呼吸/战斗]", desc: "播放指定动作语音" },
            { icon: 78, title: "#三角洲语音列表", desc: "查看所有可用角色" },
            { icon: 61, title: "#三角洲语音分类", desc: "查看音频分类" },
